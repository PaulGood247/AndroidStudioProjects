...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    //LatLng originLatLng = bundle.getParcelable("origin");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            Toast.makeText(this, "Error loading origin or destination1\nPress back and re-enter!", Toast.LENGTH_LONG).show();
        }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if(originLatLng != null && destLatLng !=null) {
            ...
            //Toast.makeText(this, "Error with LAT/LNG", Toast.LENGTH_SHORT).show();
        }
